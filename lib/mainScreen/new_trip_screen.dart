...
import 'package:uberme/widgets/fare_amount_collection_dialog.dart';
...
class _NewTripScreenState extends State<NewTripScreen>
{
  ...
  getDriversLocationUpdatesAtRealTime()
  {
        ...
        .listen((Position position)
    {
      ...
      Marker animatingMarker = Marker(
        ...
        infoWindow: const InfoWindow(title: "Ceci est ta position"),
      );
                  ...
                  children: [
                    ...
                    ElevatedButton.icon(
                      onPressed: () async
                      {
                        ...
                        //user has already sit in driver car -driver start trip now//Let's go button
                        ...
                        //user/driver reached to the dropOff destination location -end go button
  ...
  endTripNow() async
  {
    ...
    var tripDirectionDetails = await AssistantMethods.obtainOriginToDestinationDirectionsDetails(
        currentDriverPositionLatLng,
        widget.userRideRequestDetails!.originLatLng!
    );
    //Fare Amount
    double totalFareAmount =AssistantMethods.calculateFarAmountFromOriginToDestination(tripDirectionDetails!);
    FirebaseDatabase.instance.ref()
        .child("All Ride Requests")
        .child(widget.userRideRequestDetails!.rideRequestId!)
        .child("fareAmount")
  ...
  saveAssignedDriverDetailsToUserRideRequest()
  {
    ...
    databaseReference.child("driverName").set(onlineDriverData.nom);
